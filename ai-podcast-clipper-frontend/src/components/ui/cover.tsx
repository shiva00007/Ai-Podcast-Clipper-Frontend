...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className="group/cover relative inline-block rounded-sm bg-neutral-100 bg-clip-content px-2 py-2 transition duration-200 hover:bg-black dark:bg-neutral-900"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
