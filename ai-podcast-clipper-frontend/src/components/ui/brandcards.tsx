  ...
  return (
    <div className="mt-7 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      <Card>
        ...
        <CardDescription>
          Create various brand templates with on-brand font style, color, logo,
      ...
      <Card>
        ...
        <CardDescription>
          Easily set up a team account to collaborate and manage creative
          projects with your team members.
        </CardDescription>
      </Card>
      <Card>
        <CardSkeletonContainer>
        ...
        <CardDescription>
          With our API, you can integrate Any AI Modles with your CMS and other
          tools to automate your video creation workflow.
        </CardDescription>
      </Card>
    </div>
  );
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "group mx-auto w-full max-w-sm rounded-xl border border-[rgba(255,255,255,0.10)] bg-[rgba(26,24,24,0.7)] p-8",
        className,
      )}
    >
      {children}
...
export const CardTitle = ({
  ...
  return (
    <h3 className={cn("py-2 text-2xl font-semibold text-white", className)}>
      {children}
    </h3>
  );
};
...
export const CardDescription = ({
  ...
  return (
    <p className={cn("max-w-sm text-lg font-normal text-gray-400", className)}>
      {children}
    </p>
  );
};
